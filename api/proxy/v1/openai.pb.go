...
const file_api_proxy_v1_openai_proto_rawDesc = "" +
	...
	"\x05chunk\x18\x01 \x01(\tR\x05chunk*q\n" +
	"\vErrorReason\x12\x16\n" +
	"\fINVALID_ROLE\x10\x00\x1a\x04\xa8E\x90\x03\x12\x17\n" +
	"\rEMPTY_CONTENT\x10\x01\x1a\x04\xa8E\x90\x03\x12\x13\n" +
	"\tNO_CHOICE\x10\x02\x1a\x04\xa8E\xf7\x03\x12\x16\n" +
	"\fOPENAI_ERROR\x10\x03\x1a\x04\xa8E\xf7\x03\x1a\x04\xa0E\xf4\x03*\xc5\x01\n" +
